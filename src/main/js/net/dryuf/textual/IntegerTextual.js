...
net.dryuf.registerClass("net.dryuf.textual.IntegerTextual", "net.dryuf.textual.PreTrimTextual",
{
	constructor:			function() { return this; },
	check:				function(text, style)
	{
		if (text.match(/^[-+]?\d+$/, text) == null)
			return "net.dryuf.textual.IntegerTextual^Integer number required";
		return null;
       	},
