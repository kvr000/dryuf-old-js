...
net.dryuf.registerClass("net.dryuf.textual.LineTrimTextual", "net.dryuf.textual.PreTrimTextual",
{
	constructor:			function() { return this; },
	check:				function(text, style)
	{
		if (text.indexOf("\n") >= 0)
			return "net.dryuf.textual.LineTrimTextual^only one line allowed";
		return null;
	},
