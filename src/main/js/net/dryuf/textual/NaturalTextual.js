...
net.dryuf.registerClass("net.dryuf.textual.NaturalTextual", "net.dryuf.textual.PreTrimTextual",
{
	constructor:			function() { return this; },
	check:				function(text, style)
	{
		if (text.match(/^\+?\d+$/, text) == null)
			return "net.dryuf.textual.NaturalTextual^Natural number required";
		return null;
       	},
